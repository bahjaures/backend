...
$sql = "SELECT Abonnements.*, Utilisateurs.nom AS user_nom, Utilisateurs.prenom AS user_prenom, Utilisateurs.specialite, Utilisateurs.quartier, Utilisateurs.contact, User_Abonnements.date_debut, User_Abonnements.date_fin 
        FROM Abonnements 
